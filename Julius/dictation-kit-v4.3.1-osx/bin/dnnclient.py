...
model_path = '/Users/tam/prog/dictation-kit-v4.3.1-osx/model/dnn/'

w_filename = ["W_l1.npy", "W_l2.npy", "W_l3.npy", "W_l4.npy", "W_l5.npy", "W_output.npy"]
b_filename = ["bias_l1.npy", "bias_l2.npy", "bias_l3.npy", "bias_l4.npy", "bias_l5.npy", "bias_output.npy"]
prior_filename = "prior.dnn"

for i in range(len(w_filename)):
    w_filename[i] = model_path + w_filename[i]
for i in range(len(b_filename)):
    b_filename[i] = model_path + b_filename[i]
prior_filename = model_path + prior_filename
